...
public class ThrowdeviceActivity extends Activity implements OnClickListener{
    ...
    public void onClick(View v) {
            switch(v.getId()){
                case R.id.throwButton:
                    Intent recordThrow = new Intent(this, RecordthrowActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 0) {
            if (resultCode == RESULT_OK) {
                ...
                resultVar = "Power: " + power + " Hangtime : "+ hangtime + " Total : "+(float)total/100.0+"米";
                ...
                shareToFacebook.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                       ...
                       fbHandler = new Intent(ThrowdeviceActivity.this,FbhandlerActivity.class);
