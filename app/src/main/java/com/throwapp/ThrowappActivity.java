...
public class ThrowappActivity extends Activity implements OnClickListener
{
    @Override
    ...
    // Listeners for main menubuttons
        ...
        switch(v.getId()){
            ...
            case R.id.throwDeviceButton:
                Intent TDBL = new Intent(this, ThrowdeviceActivity.class);
                startActivity(TDBL);
                
            break;
                
            case R.id.localHSButton:
                Intent LHSB = new Intent(this, LocalhighscoreActivity.class);
                startActivity(LHSB); 
            break;
                
            case R.id.globalHSButton:
                Intent GHSB = new Intent(this, GlobalhighscoreActivity.class);
                startActivity(GHSB); 
            break;
            }
        };
